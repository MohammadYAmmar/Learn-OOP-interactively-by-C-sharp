...
{
    class PC_IMaintenance : ComputerIMaintenance
    {
        ...
        public PC_IMaintenance()
        {
            
        }
        public PC_IMaintenance(string name, string CPU_model, int RAM_size, string HardDisk_size, bool SSD_HardDisk, DateTime manufacturingYear, bool mouse_included, bool keyboard_included, bool speaker_included, bool UPS_included)
        {
            base.name = name;
        ...
        public PC_IMaintenance(bool mouse_included, bool keyboard_included, bool speaker_included, bool UPS_included)
        {
            this.mouse_included = mouse_included;
            this.keyboard_included = keyboard_included;
            this.speaker_included = speaker_included;
